                ...
                <PanelFilterGroup
                    ...
                    <PanelFilterList>
                        <Filter
                            ...
                            property="Show Me"
                            predicate={
                                this.state["show-me"].selectedItem.label
                            }>
                            <Picklist
                                isInline
                                label="Show Me"
                                onSelect={selectedItem => {
                                    this.onSelectPicklist(
                                        selectedItem,
                                        "show-me");
                                }}
                                ...
                                value={
                                    this.state["show-me"].selectedPicklistItem
                                        .value
                                }/>
                        </Filter>
                    </PanelFilterList>
                        ...
                        <PanelFilterList>
                            {this.state["created-date"].isActive ? (
                                <Filter
                                    ...
                                    predicate={
                                        this.state["created-date"].selectedItem
                                            .label
                                    }
                            ...
                            {this.state["list-price"].isActive ? (
                                <Filter
                                    ...
                                    onRemove={this.onRemove}
                                    predicate={
                                        this.state["list-price"].selectedItem
                                            .label
                                    }
                                    property="List Price">
                                    <Picklist
